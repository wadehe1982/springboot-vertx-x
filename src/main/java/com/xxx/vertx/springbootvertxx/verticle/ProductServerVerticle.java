...
import com.xxx.vertx.springbootvertxx.utils.Constants;
...
import static com.xxx.vertx.springbootvertxx.utils.Constants.ADD_PRODUCT_ADDRESS;
import static com.xxx.vertx.springbootvertxx.utils.Constants.PATCH_PRODUCT_ADDRESS;
...
//                .exceptionHandler(
//                throwable -> {
//                    log.error("HTTPServer error happened: {}", throwable.toString());
//                }
//        );
    }
    ...
    private void handlePatchProduct(RoutingContext routingContext){
        ...
        vertx.eventBus().<JsonObject>send(PATCH_PRODUCT_ADDRESS, product, asyncResult -> {
    ...
    private void handleAddProduct(RoutingContext routingContext) {
        ...
        JsonObject product = routingContext.getBodyAsJson();
        vertx.eventBus().<JsonObject>send(ADD_PRODUCT_ADDRESS, product, asyncResult -> {
